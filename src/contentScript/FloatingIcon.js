  ...
  useEffect(() => {
    if (file !== 0 && selectedTexts != [] && bakchodiover) {
      ...
      chrome.storage.local.get(["autotoken69"], (tokenResult) => {
        ...
        fetch("http://127.0.0.1:8787/addcontent", {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
  ...
  useEffect(() => {
    if (record) {
      chrome.storage.local.get(["autotoken69"], (tokenResult) => {
        ...
        // Send request to backend
        fetch("http://127.0.0.1:8787/getallfiles", {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
        ...
        chrome.storage.local.get(["autotoken69"], (tokenResult) => {
          ...
          chrome.storage.local.get([url], (storedResult) => {
            if (storedResult[url]) {
              ...
              fetch("http://127.0.0.1:8787/getfiletitle", {
                method: "POST",
                headers: {
                  Authorization: `Bearer ${token}`,
                  "Content-Type": "application/json",
              ...
              // fetch("http://127.0.0.1:8787/getfilecontent", {
              //   method: "POST",
              //   headers: {
              //     Authorization: `Bearer ${token}`,
              //     "Content-Type": "application/json",
              ...
              setbakchodiover(false);
              fetch("http://127.0.0.1:8787/geturl", {
                method: "POST",
                headers: {
                  Authorization: `Bearer ${token}`,
                  "Content-Type": "application/json",
                ...
                .then((data) => {
                  if (data.success) {
                    ...
                    fetch("http://127.0.0.1:8787/newfile", {
                      method: "POST",
                      headers: {
                        Authorization: `Bearer ${token}`,
                        "Content-Type": "application/json",
                      ...
                      .then((data) => {
                        if (data.success) {
                          ...
                          fetch("http://127.0.0.1:8787/upserturl", {
                            method: "POST",
                            headers: {
                              Authorization: `Bearer ${token}`,
                              "Content-Type": "application/json",
...
function FilesDisplay({
  ...
  return (
    <NotesContainer y={position.y} x={position.x + offset}>
      ...
      {record && (
        <Heading>
          <Subheading>{"Current file: "}</Subheading>
          {filetitle ? filetitle : ""}
        ...
        <Subheading>
          ...
          {selectedTexts && selectedTexts.length != 0 ? (
            <>
              ...
              {"    "}{<button onClick={()=>{
                setRegetfiles(x=>!x);
              }}> <svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 21 21"><g fill="white" fill-rule="evenodd" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M6.5 3.5c-2.412 1.378-4 4.024-4 7a8 8 0 0 0 8 8m4-1c2.287-1.408 4-4.118 4-7a8 8 0 0 0-8-8"/><path d="M6.5 7.5v-4h-4m12 10v4h4"/></g></svg> </button>}
            </>
          ) : (
            <>{":  "}{<button onClick={()=>{
              setRegetfiles(x=>!x);
