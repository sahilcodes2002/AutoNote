                          ...
                          if (username == "") {
                            ...
                            try {
                              const response = await axios.post(
                                "http://127.0.0.1:8787/varification",
                                {
                                  email: username.trim(),
                                }
                              );
                      ...
                      >
                        {!loading && (
                          <p>
                            ...
                            {verifytry == 0 && <p>Send verification code</p>}
                          </p>
                        )}
                        {loading && <p>Loading..</p>}
                      </button>
                          ...
                          <button
                            onClick={async () => {
                              if (username == "") {
                                ...
                                try {
                                  const response = await axios.post(
                                    "http://127.0.0.1:8787/varifycode",
                                    {
                                      email: username.trim(),
