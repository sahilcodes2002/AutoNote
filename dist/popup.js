...
function Dashboard(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "popup shadow-md rounded-lg overflow-hidden"
  ...
  }, "Show FLoating Menu")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "pt-2 mr-4 "
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
    ...
    "class": "border-t-4 border-gray-400 my-4 "
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    className: "pt-2 mr-5  ".concat(!defaultstate ? "text-blue-600 font-bold" : "")
    ...
    className: "box block h-8 w-14 rounded-full ".concat(defaultstate ? "bg-blue-600" : "bg-gray-400")
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "absolute left-1 top-1 flex h-6 w-6 items-center justify-center rounded-full bg-white transition ".concat(defaultstate ? "translate-x-full" : "")
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "pt-2 ml-5  ".concat(defaultstate ? "text-blue-600 font-bold" : "")
  }, "Always show")))))));
}
...
function Loginpage(_ref) {
  ...
  var handleSignIn = function handleSignIn() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("http://127.0.0.1:8787/signin", {
      username: username,
      password: password
    }).then(function (response) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            _context.prev = 7;
            _context.next = 10;
            return axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("http://127.0.0.1:8787/varification", {
              email: username.trim()
            });
          case 10:
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            _context2.prev = 7;
            _context2.next = 10;
            return axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("http://127.0.0.1:8787/varifycode", {
              email: username.trim(),
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            _context3.prev = 5;
            _context3.next = 8;
            return axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("http://127.0.0.1:8787/signup", {
              name: firstName,
              username: username,
              password: password
            });
...
var Popup = function Popup() {
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("signup"),
    _useState2 = _slicedToArray(_useState, 2),
    page = _useState2[0],
